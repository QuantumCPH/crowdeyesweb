      ...
      <div id="searchCategory" class="row text-center searchCategory" ng-app="myApp" ng-controller="customersCtrl">
        <div class="col-md-3 col-sm-6 col-xs-12">
		  ...
		  <span>
            ...
            <img class="lostImg2" ng-hide="cat1.PictureURIs[0].URI" src="{{cat1.PictureURIs[0].URI}}" />
            <img class="lostImg2" ng-show="cat1.PictureURIs[0].URI" src="<?php echo get_template_directory_uri(); ?>/assets/img/placeholder-44.png">
            ...
            <div class="greenInner3">
              ...
              <div class="greenInner1">
                <img ng-hide="{{cat.CreatedBy_Profile.Picture.URI}}" class="imgFirst" src="{{cat.CreatedBy_Profile.Picture.URI}}" />
                <img ng-show="{{cat.CreatedBy_Profile.Picture.URI}}" class="imgFirst" src="<?php echo get_template_directory_uri(); ?>/assets/img/user.png">
<span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
		  ...
		  <span>
			  ...
			  <img class="lostImg2"   ng-hide="cat1.PictureURIs[0].URI" src="{{cat1.PictureURIs[0].URI}}" />
            <img class="lostImg2" ng-show="cat1.PictureURIs[0].URI" src="<?php echo get_template_directory_uri(); ?>/assets/img/placeholder-22.png">
		  </span>
              <div class="rightGreen">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
		  ...
		  <span>
		     <img ng-if="cat3.TypeID == 1" class="lostImg" src="<?php echo get_template_directory_uri(); ?>/assets/img/lost.png" />
			  ...
			  <img class="lostImg2"   ng-hide="cat1.PictureURIs[0].URI" src="{{cat1.PictureURIs[0].URI}}" />
            <img  class="lostImg2" ng-show="cat1.PictureURIs[0].URI" src="<?php echo get_template_directory_uri(); ?>/assets/img/placeholder-33.png">
		  </span>
              <div class="rightGreen">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
		  ...
		  <span>
			  ...
			  <img class="lostImg2"   ng-hide="cat1.PictureURIs[0].URI" src="{{cat1.PictureURIs[0].URI}}" />
              <img class="lostImg2" ng-show="cat1.PictureURIs[0].URI" src="<?php echo get_template_directory_uri(); ?>/assets/img/placeholder-11.png">
		  </span>
              <div class="rightGreen">
