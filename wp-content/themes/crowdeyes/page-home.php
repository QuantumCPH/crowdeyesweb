  ...
  <section id="features">
    <div class="container">
      ...
      <style>
        ...
        .lostImg2{ height:90px; width:95px; background-size: cover !important; border-radius: 5px; border: solid 0px #fff;}
      </style>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="greenBox" ng-repeat="cat1 in catadata1"  ng-cloak>
            ...
            <span>
              ...
              <div class="lostImg2" ng-show="cat1.PictureURIs[0].URI" style="background: url({{cat1.PictureURIs[0].URI}}) !important; background-size: cover !important;"></div>
